# Leccy — EV Cost Tracker v1.6.3: Installation Guide
...
Leccy v1.6.3 is a fully-featured **Progressive Web App**. Once deployed behind HTTPS, supported browsers show an in-app install prompt on first load. Users can also install it directly from their browser menu with no app store required.
