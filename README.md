...
- Start a charge quickly, save it as a local draft, and finish submission later
...
- **Quick Data Entry** — save charge-start odometer, battery, and range, then complete end data later (v1.3.0)
